...
const myuser = prompt('user');

// Listen for changes in elements and send XML to the server
modeler.on('elements.changed', () => {
  getXMLfromModel().then((xml) => {
    socket.emit('model', xml.xml);
  });
});